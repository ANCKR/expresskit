...
exports.deleteUserDetails = (0, asyncHandeler_1.default)(async (req, res) => {
  ...
  const auths = await auth_1.default.destroy({
...
exports.profileDetailsByUserId = (0, asyncHandeler_1.default)(
  async (req, res) => {
    const uniqueIdKey = req.params.id;
...
exports.uploadFile = (0, asyncHandeler_1.default)(async (req, res) => {
  ...
  for (let attempt = 1; attempt <= RETRY_LIMIT; attempt++) {
    try {
      ...
      const publicUrl = await (0, fileUpload_1.uploadFileToSupabase)(
        fileBuffer,
        file.filename,
      );
...
exports.downloadFile = (0, asyncHandeler_1.default)(async (req, res) => {
  ...
  for (let attempt = 1; attempt <= RETRY_LIMIT; attempt++) {
    try {
      ...
      if (user) {
        const { imageName, mimeType, data } = await (0, fileDownload_1.default)(
          user.image,
          res,
        );
        res.setHeader(
...
exports.userNotification = (0, asyncHandeler_1.default)(async (req, res) => {
  try {
    ...
    const notification = await (0, sendNotification_1.sendNotification)(
      token,
      title,
      body,
    );
...
exports.uploadImageBase64 = (0, asyncHandeler_1.default)(async (req, res) => {
  ...
  for (let attempt = 1; attempt <= RETRY_LIMIT; attempt++) {
    try {
      ...
      const publicUrl = await (0, fileUpload_1.uploadFileToSupabaseBase64)(
        buffer,
        image,
      );
      const [updated] = await user_1.default.update(
