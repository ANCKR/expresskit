...
const userResolver = {
  Query: {
    getUsers: (0, asyncHandelerForGraphql_1.default)(
    ...
    getUser: (0, asyncHandelerForGraphql_1.default)(
      async (_, { id }, context) => {
        if (!context.user) {
          throw (0, customError_1.createCustomError)("Unauthorized");
        }
  ...
  Mutation: {
    ...
    uploadFile: (0, asyncHandelerForGraphql_1.default)(
      async (_, { file }, context) => {
        if (!context.user) {
          throw (0, customError_1.createCustomError)("Unauthorized");
        }
        const RETRY_LIMIT = 3;
