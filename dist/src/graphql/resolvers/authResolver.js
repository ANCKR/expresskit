...
const asyncHandelerForGraphql_1 = __importDefault(
  require("../../utils/asyncHandelerForGraphql"),
);
...
const authResolver = {
  Query: {
    users: (0, asyncHandelerForGraphql_1.default)(
  ...
  Mutation: {
    signUp: (0, asyncHandelerForGraphql_1.default)(
      async (_, { username, password }, context) => {
        ...
        exports.generateAccessAndRefereshTokens)(username, uniqueIdKey);
        context.res
    ...
    updateUser: (0, asyncHandelerForGraphql_1.default)(
      async (_, { id, username, password }, context) => {
        if (!context.user) {
          throw (0, customError_1.createCustomError)("Unauthorized");
        }
        if (!(0, validation_1.default)(username, "emailcheck")) {
    ...
    deleteUser: (0, asyncHandelerForGraphql_1.default)(
      async (_, { id }, context) => {
        if (!context.user) {
          throw (0, customError_1.createCustomError)("Unauthorized");
        }
    ...
    signIn: (0, asyncHandelerForGraphql_1.default)(
      async (_, { username, password }, context) => {
        if (!(0, validation_1.default)(username, "emailcheck")) {
          throw (0, customError_1.createCustomError)("Invalid username");
        }
    ...
    refreshAccessTokenChanger: (0, asyncHandelerForGraphql_1.default)(
      async (_, args, context) => {
        ...
        const checkResult = await (0, checkUserExist_1.checkUserData)(
          user.username,
        );
    ...
    resetPassword: (0, asyncHandelerForGraphql_1.default)(
      async (_, { unique_id_key, password }, context) => {
        if (!(0, validation_1.default)(password, "passwordcheck")) {
          throw (0, customError_1.createCustomError)("Invalid password");
        }
        const hashedPassword = await bcrypt_1.default.hash(password, 10);
        const user = await auth_1.default.update(
          { password: hashedPassword },
          { where: { unique_id_key: unique_id_key } },
        );
        if (!user) {
    ...
    forgotPassword: (0, asyncHandelerForGraphql_1.default)(
      async (_, { username }, context) => {
        if (!(0, validation_1.default)(username, "emailcheck")) {
          throw (0, customError_1.createCustomError)("Invalid username");
        }
        const user = await auth_1.default.findOne({
